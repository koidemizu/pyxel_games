...
class App:
 ...
 def MapEvents_ctr(self,x,y):
     ...
     if xy_key == "1-2":
         ...
         pyxel.tilemap(0).set(7+112, 7+96, ["005005"]) 
     elif xy_key == "7-5":
         pyxel.tilemap(0).set(7+112, 12+80, ["005005"]) 
     elif xy_key == "6-5":
         pyxel.tilemap(0).set(7+96, 10+80, ["005005"]) 
     elif xy_key == "8-11":
         ...
         pyxel.tilemap(0).set(7+0, 13+144, ["000000"]) 
         ...
         pyxel.tilemap(0).set(3+80, 3+176, ["157"]) 
     elif xy_key == "7-11":
         pyxel.tilemap(0).set(7+96, 10+176, ["006006"]) 
         pyxel.tilemap(0).set(7+96, 11+176, ["006006"]) 
         ...
         pyxel.tilemap(0).set(6+64, 1+176, ["001001"]) 
     elif xy_key == "3-121":
         pyxel.tilemap(0).set(11+48, 5+192, ["001001"]) 
     elif xy_key == "3-141":
         pyxel.tilemap(0).set(7+48, 15+224, ["006006"]) 
     elif xy_key == "3-14":
         pyxel.tilemap(0).set(15+48, 8+224, ["00A"]) 
         pyxel.tilemap(0).set(15+48, 7+224, ["00A"]) 
         self.b3_l = False
         pyxel.clip()
         if self.items3[6] == 0:
             self.items3[6] = 1
         ...
         pyxel.tilemap(0).set(6+64, 15+144, ["001001"]) 
     elif xy_key == "13-7":
         if self.items4[4] == 0:
             self.items4[4] = 1
         ...
         pyxel.tilemap(0).set(9+208, 12+64, ["006"])             
     elif xy_key == "15-4":
         pyxel.tilemap(0).set(6+240, 12+64, ["000000000000000"])          
     elif xy_key == "14-501":
         pyxel.tilemap(0).set(5+224, 9+64, ["1AD"]) 
         pyxel.tilemap(0).set(7+224, 0+64, ["003003"]) 
         pyxel.tilemap(0).set(6+224, 7+64, ["02101B01C021"]) 
     elif xy_key == "14-502":
         pyxel.tilemap(0).set(10+224, 9+64, ["1AF"]) 
         pyxel.tilemap(0).set(7+224, 1+64, ["003003"]) 
         pyxel.tilemap(0).set(6+224, 6+64, ["02101B01C021"]) 
     elif xy_key == "14-30":
         pyxel.tilemap(0).set(7+224, 13+48, ["003003"]) 
         pyxel.tilemap(0).set(7+224, 8+48, ["016017"]) 
         pyxel.tilemap(0).set(7+224, 9+48, ["018019"])          
         pyxel.tilemap(0).set(7+224, 15+48, ["1A11A1"])    
     elif xy_key == "14-3":
         pyxel.tilemap(0).set(7+224, 5+48, ["012012"]) 
         pyxel.tilemap(0).set(7+224, 15+48, ["003003"])              
         pyxel.tilemap(0).set(7+240, 0+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 1+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 2+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 3+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 4+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 5+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 6+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 7+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 8+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 9+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 10+64, ["000"])      
         pyxel.tilemap(0).set(7+240, 11+64, ["000"])    
         if self.items4[6] == 0:
             self.items4[6] = 1     
         if self.items4[7] == 0:
             self.items4[7] = 1                  
         ...
         for i in range(12):
             ...
             pyxel.tilemap(0).set(0+224, 13-i+32, 
                            ["28E28F"])                       
         pyxel.tilemap(0).set(0+224, 0+32, ["288289"])                           
         pyxel.tilemap(0).set(14+224, 0+32, ["28A28B"])                           
         pyxel.tilemap(0).set(0+224, 1+32, ["2A82A9"])                           
         pyxel.tilemap(0).set(14+224, 1+32, ["2AA2AB"])                  
         pyxel.tilemap(0).set(2+224, 1+32, 
                              ["2B02B12B02B12B02B12B02B12B02B12B02B1"])     
         pyxel.tilemap(0).set(2+224, 0+32, 
                              ["290291290291290291290291290291290291"])     
         pyxel.tilemap(0).set(2+224, 1+32, 
                              ["2B02B12B02B12B02B12B02B12B02B12B02B1"])     
         pyxel.tilemap(0).set(6+224, 15+32, 
                        ["2B32B42B5"])          
         pyxel.tilemap(0).set(6+224, 14+32, 
                        ["293294295"])                           
         pyxel.tilemap(0).set(7+224, 10+32, 
                        ["342343"])                 
         pyxel.tilemap(0).set(7+224, 11+32, 
                        ["362363"])          
         pyxel.tilemap(0).set(7+224, 12+32, 
                        ["342343"])          
         pyxel.tilemap(0).set(7+224, 13+32, 
                        ["362363"])                          
         pyxel.tilemap(0).set(7+224, 7+32, 
                        ["2E22E3"])                 
         pyxel.tilemap(0).set(7+224, 8+32, 
                        ["302303"])        
         pyxel.tilemap(0).set(7+224, 9+32, 
                        ["342343"])        
